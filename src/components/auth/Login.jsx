...
import { Eye, EyeOff, Lock, Mail, ArrowRight, ShieldCheck, Wallet } from 'lucide-react';
...
export default function FinanceLogin() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!email || !password) {
      toast.error('Please enter your financial account credentials.');
      return;
    }
      ...
      <div className="min-h-screen w-full bg-gradient-to-br from-[#0B2E33] via-[#4F7C82] to-[#0B2E33] flex items-center justify-center p-4 md:p-8 font-sans text-white relative overflow-hidden">
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 items-center gap-8 xl:gap-12 z-10">
          ...
          <div className="w-full flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md bg-[#0B2E33]/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-[#93B1B5]/30 p-8 md:p-10 flex flex-col justify-between transform transition-all duration-300 hover:shadow-[#B8E3E9]/10">
              
              <div className="space-y-6">
                
                <div className="text-center space-y-2">
                  <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-tr from-[#4F7C82] to-[#B8E3E9] text-[#0B2E33] mb-2 shadow-lg shadow-[#B8E3E9]/20 transform transition-transform duration-300 hover:scale-110">
                    <Wallet size={28} className="stroke-[2.5]" />
                  </div>
                  <h1 className="text-2xl font-bold tracking-tight text-white drop-shadow-sm">
                    Login
                  </h1>
                  <p className="text-xs text-[#93B1B5] font-medium">
                    Access your portfolios, budgets, and transactions
                  </p>
                </div>
                ...
                <div className="relative flex items-center justify-center my-4">
                  ...
                  <span className="absolute bg-[#0B2E33] px-3 text-[10px] font-bold text-[#93B1B5] tracking-widest uppercase">
                    Or email
                  </span>
                </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <Lock className={`absolute left-3.5 top-1/2 -translate-y-1/2 transition-colors duration-200 ${
                        activeField === 'password' ? 'text-[#B8E3E9]' : 'text-[#93B1B5]'
                      }`} size={18} />
                      <input 
              ...
              <div className="text-center pt-8 text-xs font-medium text-[#93B1B5]">
                Need a financial account?{' '}
                <button 
                  type="button"
              ...
              <div className="mt-6 pt-4 border-t border-[#93B1B5]/15 flex items-center justify-center gap-1.5 text-[11px] text-[#93B1B5] font-medium">
